      ...
      <div class="section-body">
        <div class="row">
          <div class="col-12 col-md-12 col-lg-12">
            ...
            <form action="{{ route('quize-store') }}" method="post" id="quizeFrm" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <h4> Add Quiz </h4>
                    <hr>
                        <div class="row">
                            <input type="hidden" name="cours_m_id" value="{{ $subModule->id }}">
                            <div class="col-sm-6">
                           ...
                           <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="dueDateTime" name="start_date" class="form-control">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" id="dueDate" name="start_time" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="default_marks" class="form-control">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="time_limit" class="form-control">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.success==true) {   
                            toastr.success("Quiz Creted Successfully");
                            window.setTimeout(function() {
