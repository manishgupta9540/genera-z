...
@section('title', 'Question Quize List')
...
<div class="main-content">
    <section class="section">
        <div class="row">
            <div class="col-md-8">
                <h3>Courses / Module / Sub Module / Assignment / Question</h3>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function(){
                ...
                function(e) {
                    if (e == true) {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "{{ route('question-quize-delete') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                'id': id,
                                'table_name': table
        ...
        $(document).on('click', '.status', function (event) {
            ...
            // icon: "warning",
            type: "warning",
            title: 'Are you sure you want to '+ action +' the question quize?',
            text: "",
            dangerMode: true,
            showCancelButton: true,
            confirmButtonColor: "#007358",
