          ...
          <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <form action="{{ route('skills-create') }}" method="post" id="createskillFrm" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="skills_name"  class="form-control" placeholder="Skills Name">
