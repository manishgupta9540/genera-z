                ...
                <div class="card-header">
                    @if(Auth::user()->user_type != '0')
                        ...
                        @foreach ($permissions as $item)
                            @if($item->action == 'skills-create')
                                <a href="{{route('skills-create')}}" class="btn btn-primary btn-sm ">Add Skill</a>
                            @endif
                        @endforeach
                    @else
                        <a href="{{route('skills-create')}}" class="btn btn-primary btn-sm ">Add Skill</a>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.status', function (event) {
            ...
            // icon: "warning",
            type: "warning",
            title: 'Are you want to '+ action +' Skills?',
            text: "",
            dangerMode: true,
            showCancelButton: true,
            confirmButtonColor: "#007358",
