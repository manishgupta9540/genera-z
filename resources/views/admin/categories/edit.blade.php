          ...
          <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <form action="{{ route('category-update') }}" method="post" id="updatedCategoryFrm">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" class="summernote form-control" cols="30" rows="10">{{ $category->description }}</textarea>
...
@push('customjs')
    ...
    <script>
            // $(document).on('submit', 'form#updatedCategoryFrm', function (event) {
